...
public class Pintura extends Producto {
	...
	public Pintura(boolean esOleo, boolean esVinilo, float contenidoML, String color) {
		super();
		this.esOleo = esOleo;
	...
	public Pintura(double precio, int cantidad, String nombreProducto, String marca, boolean esOleo, boolean esVinilo,
			float contenidoML, String color) {
	...
	public Pintura(double precio, int cantidad, String nombreProducto, String marca) {
		super(precio, cantidad, nombreProducto, marca);
		// TODO Auto-generated constructor stub
	}
