...
/**
 * La clase abstracta ProductoDTO representa un producto de transferencia de
 * datos (DTO) con atributos básicos como precio de compra, precio de venta,
 * cantidad, nombre, tamaño y marca. Esta clase sirve como base para otros DTOs
 * de productos más específicos.
 * 
...
public abstract class ProductoDTO {
	...
	/**
	 * Constructor que inicializa un ProductoDTO con los atributos proporcionados.
	 * 
	 ...
	 */
	public ProductoDTO(double precioCompra, double precioVenta, int cantidad, String nombre, String tamanio,
			String marca) {
		super();
